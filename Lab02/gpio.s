...
EsperaGPIO  LDR     R1, [R0]						;Lê da memória o conteúdo do endereço do registrador       
			MOV     R2, #GPIO_PORTJ                 ; Seta os bits correspondentes às portas para fazer a comparação - Seta o bit da porta J
...
;    Sem função alternativa
            MOV     R1, #0x00						; Colocar o valor 0 para não setar função alternativa				; Escreve na porta
...
; 8. Interrupções
			...
			MOV R0, #2_0 							; Desabilita a interrupção na porta J0
			STR R0, [R1] 
			...
			LDR R1, =GPIO_PORTJ_ICR_R				; Configura a interrupção na porta PJ0
			MOV R0, #2_1
			STR R0, [R1]
