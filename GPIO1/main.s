...
Verifica_Nenhuma
	...
	BL GPIOPortJ_Handler			 	 ;Chamar a função para não acender nenhum LED
...
Verifica_SW1	
	...
	BL GPIOPortJ_Handler			 ;Chamar a função para setar o LED3
...
Verifica_SW2	
	...
	BL GPIOPortJ_Handler			 ;Chamar a função para setar o LED4
	B MainLoop                   ;Volta para o laço principal	
Verifica_Ambas
	...
	MOV R0, #2_00010001			 ;Setar o parâmetro de entrada da função como o BIT0
                                 ;e o BIT4
	BL GPIOPortJ_Handler		  	 	 ;Chamar a função para acender os dois LEDs
	B MainLoop                   ;Volta para o laço principal	
